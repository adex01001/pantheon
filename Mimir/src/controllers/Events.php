...
class EventsController extends Controller
{
    ...
    public function updatePlayerSeatingFlag($playerId, $eventId, $ignoreSeating)
    {
        ...
        (new EventUserManagementModel($this->_ds, $this->_config, $this->_meta))->updateSeatingFlag(
            $playerId,
            $eventId,
            $ignoreSeating
        );
    ...
    public function getAchievements($eventIdList)
    {
        ...
        $table = (new AchievementsModel($this->_ds, $this->_config, $this->_meta))->getAchievements($eventIdList);
